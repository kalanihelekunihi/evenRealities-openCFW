...
APPLE_AGGREGATE_PINS = {
    "overlay": (125_258, "1f71240bd75af28798d93eba217b99464156ee40ae353333c2fd0f449b9a8c76"),
    "component": (3_648_654, "36b7f32f9f5f1a4c2fbf800b8cda0f48aa521bfc87638d671932b80b49f7e991"),
    "package": (4_427_148, "532743c6a1b96f198f0991c320bf3318eac88bc538a90a9e0b0267aaacef07b3"),
    "build_report": (2_323, "19972d9794b3b6ac6272b2c5d5cd782e528378fcdce4133b9f0856caf6e36f4a"),
    "flash_plan": (740_977, "b4b6e72d4ff7be47ca96a845a943320dfb65732c1de10d2bbb18051626cf2f95"),
}
LINUX_AGGREGATE_PINS = {
    "overlay": (127_082, "f24cf0e060530429679df9389571ffee397819dfa2c3abc00d26deb75a3e47ad"),
    "component": (3_650_478, "5fe58e3af2a0b7fed55c6b7c33afbd1ac5c887860721b04859e2d49d81be828c"),
    "package": (4_428_972, "22117e0cd7d0b827a8c31d22eb509edb30651fef6a6308838a8220ff80f6c702"),
    "build_report": (2_322, "91c854c0a580bdd2cbc961a47b3f89943920c109b5baaa9a7e40a73ccb520fb5"),
    "flash_plan": (605_604, "9da3d20004434bace4a5af3b88c720de1a38eb8b6cfda426f0d053309bbca327"),
}
...
REVIEWED_COMPILERS = {
    "Apple clang version 21.0.0 (clang-2100.3.27.1)": "/usr/bin/clang",
...
def validate_atomic_production_topology(
    ...
    if observed_counts != PRODUCTION_COUNTS:
        raise AssertionError(
            "production overlay inventory must be exactly 663 functions, "
            "612 patch sites, and 94 relocated leaves"
        )
