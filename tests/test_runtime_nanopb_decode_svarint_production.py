...
PROVENANCE_PIN = (
    56_997,
    "b4341b0ed98a697a0156d9d0c9fca2a"
    "03bed304ca890f56ea70c7eb590fa4283",
)
VERIFIER_PIN = (
    146_028,
    "67e7681f1bb31086d9eb3b95700b8831"
    "96030e2b702cb05ef47205f77d6d2cc6",
)
...
LINUX_AGGREGATE = {
    "overlay": (
        127_082,
        "f24cf0e060530429679df9389571ffee"
        "397819dfa2c3abc00d26deb75a3e47ad",
    ),
    "component": (
        3_650_478,
        "5fe58e3af2a0b7fed55c6b7c33afbd1"
        "ac5c887860721b04859e2d49d81be828c",
    ),
    "package": (
        4_428_972,
        "22117e0cd7d0b827a8c31d22eb509edb"
        "30651fef6a6308838a8220ff80f6c702",
    ),
}

STAGED_CONSUMER_PINS = {
    MANIFEST: "5ebe8335d0e6c0738948df5cf6e054f0b6154aa4664d88467fc1582fe07dfe17",
    PROVENANCE: "b4341b0ed98a697a0156d9d0c9fca2a03bed304ca890f56ea70c7eb590fa4283",
    AUDIT: "b483e5b1915f54e99e8aefd047ece54153aadc6df4af51cdc4ef1cf81cc983d0",
    ROOT / "README.md": "0c886362490bef7742409f1164d7895be305d62a37ed070b6dceb9f8bde39b20",
    ROOT / "components/README.md": "edf83e04a51523674038149e8427f10bf63cd9dae6fa01047abb4e71892b000b",
    ROOT / "components/apollo_main/core_overlay/NOTICE.md": "f9956bd03ad780d1aa0da45baaa1cdc82cb6559daf54f8731cb5f47ee4fe2bc9",
    ROOT / "components/apollo_main/core_overlay/EVIDENCE.md": "84b03fd3edb47777160f730c97f60bde72de76b756edb838449e24062d388df5",
    ROOT / "third_party/nanopb/README.openCFW.md": "08d7deee265398ef9f3ffba7fcca44a12429be4baa88605ccacf9059b5e93f43",
    ROOT / "docs/memory-map.md": "8a96130fa21c51aa96fe1a453c3bdf186116fa2a4c2e0e371dc7369de6a99a91",
    ROOT / "docs/source-coverage.md": "7d93ee7b8cbb9e5d0465f9c2f8345f686194e2a0ebc54a5db9a2659592a7866e",
    ROOT / "docs/upstream-inventory.md": "8046c867fce8f6379fdd7b669961b319e2d403683400fbee99fcb9d782ec62d7",
...
class NanopbDecodeSvarintProductionTests(unittest.TestCase):
    ...
    def test_candidate_naming_is_absent_and_production_docs_are_registered(self) -> None:
        ...
        self.assertIn("exactly thirteen bounded altered", production_boundary)
        self.assertIn(SOURCE_PATH, production_boundary)
        self.assertIn("All thirteen", production_boundary)
        self.assertIn("only those thirteen bounded functions", production_boundary)
