...
PROFILES = {
    "apple-clang": {
        ...
        "package_accounting": (126_028, 88_659, 4_212_461),
        ...
        # Net tail retained by the current rollback overlay after its removed
        # read/svarint/skip-string closures are accounted for.
        "current_rollback_net_tail_growth": 194,
        "later_tail_growth": 2_864,
        "legacy_reset_unordered_tail_growth": 388,
        # Active rollback build from the current production registry.
        "legacy_semaphore_layout": {
            "overlay_size": 124_974,
            "overlay_sha256": (
                "483105f4282d4a8393477ad1dd45b398"
                "c3bdd8859d2f91c9206c349ef0c94353"
            ),
            "component_size": 3_648_370,
            "component_sha256": (
                "34ab0af8fb6a87ab48a8e9c6641f703c"
                "f2b496dee949240c1613534c0228f76f"
            ),
            "function_count": 656,
            "patch_count": 606,
        ...
        # Historical pre-cluster milestone, intentionally unchanged.
    ...
    def setUpClass(cls) -> None:
        ...
        def load_legacy_config(_path: Path) -> dict:
            ...
            config["patch_sites"] = [
                ...
                if patch.get("target_function") not in {
                    "open_cfw_nanopb_read",
                    "open_cfw_nanopb_decode_svarint",
                    "open_cfw_nanopb_skip_string",
                }
