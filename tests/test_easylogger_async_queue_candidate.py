...
LOCAL_PINS = {
    SOURCE: (
        9_556,
        "47bc4546cf7287e20f89d3cce7b4770c"
        "d5f5682e13274fec94185b7342ad6a04",
    ),
    HEADER: (
        7_999,
        "3c851a0c7953fde14d996b9403187804"
        "328a528f85b64cebd684503cad61131c",
    ),
    FIXTURE: (
        18_701,
        "3a15b523d0fd50eb89fcf496d70039aa"
        "2400457d45a3f32d00d1986d8baceb45",
    ),
    AUDIT: (
        16_773,
        "c7452fe6b465e97cca57f18bd9f8cbde"
        "8e315abc0c9104fc4f98b223444bbd63",
    ),
}
...
TARGET_PINS = {
    "apple-clang": {
        ...
        "object": (
            4052,
            "da30ac9920194b35cc9df99f2e25301f"
            "dea3a186471b09ddba18c2dee0afcf42",
        ),
        "functions": {
            ADAPTER_FUNCTIONS[0]: (
                4,
    ...
    "linux-clang": {
        ...
        "object": (
            4004,
            "837138da296802d2b85a69f1dc011e84"
            "c041ca03d65d57e5d3f1265c617c59a2",
        ),
        "functions": {
            ADAPTER_FUNCTIONS[0]: (
                4,
...
class EasyLoggerAsyncQueueCandidateTests(unittest.TestCase):
    ...
    def test_record_and_statistics_abis_are_exact(self) -> None:
        ...
        self.assertEqual(
            ...
            [0x04, 0x0C, 0x10, 0x14, 0x18, 0x1C, 0x20, 0x2C],
        )
    ...
    def test_host_token_adapter_counts_bad_addresses_without_hiding_them(self) -> None:
        ...
        self.loaded.open_cfw_test_easylogger_async_queue_probe_bad_address(TOKEN_3 + 0x110)
        self.assertEqual(
            self.u32("open_cfw_test_easylogger_async_queue_bad_address_count"),
            2,
        )
    ...
    def test_complete_caller_interior_and_stored_pointer_topology_is_exact(self) -> None:
        ...
        for name, (_, _, _, expected_callers, caller_digest) in STOCK_RANGES.items():
            ...
            self.assertEqual(narrow_interiors[name], [])
