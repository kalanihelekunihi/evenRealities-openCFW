...
#define OPEN_CFW_FREERTOS_CURRENT_TCB open_cfw_test_current_tcb
#include "../../research/candidates/freertos_pc_task_get_name.c"

open_cfw_freertos_u32 ulSetInterruptMask(void)
{
