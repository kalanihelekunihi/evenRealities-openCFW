...
class NanopbCloseStringSubstreamProductionTests(unittest.TestCase):
    ...
    def test_production_registration_patch_manifest_and_package_are_exact(
        ...
        split = [
            ...
            (
                "opaque_application_between_nanopb_skip_string_and_"
                "nanopb_close_string_substream",
                0x0048_F66C,
                START - 0x0048_F66C,
                "official_blob",
            ),
            ...
            (
                "opaque_application_between_nanopb_close_string_substream_"
                "and_decode_svarint",
                END,
                0x0049_0150 - END,
                "official_blob",
