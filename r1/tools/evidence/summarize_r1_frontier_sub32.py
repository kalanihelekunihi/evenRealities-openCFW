...
GOMORE_FRONTIER_LT32_FUNCTIONS = (
    ...
    _function(
        ...
        "", "float sum-of-squares accumulator (vldmia/vmla s0,s1,s1) in GoMore region 0x92xxx",
        (),
        "gomore_health_algorithm_candidate", "vendor_source_required_not_redistributable",
    ),
    _function(
...
GOODIX_FRONTIER_LT32_FUNCTIONS = (
    ...
    _function(
        ...
        "", "select fixed-point constant pair (0xf33333/0xecCCcd, 0xa66666/0xc00000) by flag; exclusive Goodix callers",
