...
GOMORE_FRONTIER_32_63_FUNCTIONS = (
    ...
    _function(
        ...
        "", "Reads FICR device id, formats the %08x_%08x_%08x key string, and copies the cached 0x40-byte provider blob; called from pinned GoMore pKey/auth scopes",
    ...
    _function(
        ...
        "", "Seven-slot provider state-bit scan (bit 2) over the GoMore record table",
    ...
    _function(
        ...
        "", "Seven-slot provider state-bit scan (bit 5) over the GoMore record table",
    ...
    _function(
        ...
        "", "Seven-slot provider state-bit scan (bit 4) over the GoMore record table",
    ...
    _function(
        ...
        "", "Seven-slot provider state-bit scan (bit 6) over the GoMore record table",
