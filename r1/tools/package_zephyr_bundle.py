...
def main() -> None:
    ...
    manifest = {
        ...
        "limitations": [
            ...
            "The exact SAADC routes and conversions are source-bound; battery sampling uses YHM2710 shared-power client bit 0, while periodic production and physical calibration remain open.",
            ...
            "The monotonic/phone-synchronized wall clock is source-bound but remains unavailable until command 0x05 supplies a valid epoch and UTC offset.",
            ...
            "The pinned Bosch/ST motion providers, exact TWIM1 route, variant probe, and bounded FIFO API are source-bound; production sample ingestion and owned-ring calibration remain open.",
            ...
            "Pinned FlashDB 2.0.0/FAL 0.5.99 now binds the recovered six-page health.db TSDB, exact startup sequence, retained crash-time/cache restore, exact 128-byte record codec, local-day recovery, non-destructive clock-to-slot-1 hourly appends, and the exact slot-0 old/new tuple for initial-valid recovery and cross-day cache reset. Temperature and stress currently serialize their module-owned zero histories; destructive format/retry, GoMore reinitialization, unresolved sync-cursor persistence, migration, and owned-hardware power-loss behavior remain suppressed or open.",
            "The pinned source-only Goodix demo/driver subset, recovered i2c_4 transport, P0.21/P0.10/P1.04 board resources, interrupt worker, and YHM2710 client bit 1 are bound. Binary archives are excluded and the unadapted biometric global ABI fails closed; raw-frame channel semantics and all optical electrical behavior remain hardware-validation gates.",
