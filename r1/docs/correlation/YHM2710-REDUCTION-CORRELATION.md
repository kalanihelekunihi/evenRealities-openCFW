...
All 36 functions classified as `yhmicros_yhm2710_candidate` are now represented by the
...
configuration adapter and is not counted among the 36 provider entries.
...
ownership ledger assigns all 36 entries
