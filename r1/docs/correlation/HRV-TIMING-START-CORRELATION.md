...
That image contains 94,804 bytes of text, 236 bytes of data, and 132,544
bytes of BSS; its standalone BIN is 95,040 bytes. The HEX and BIN SHA-256
values are `48e1b3fadfdb956fbdf5f637d48c9a5808db5394848fb4538450c0ff98be80cf`
and `421a42cf37dad04dadcff5d3b1742efcba4ba50fd1d2e52f26bcf00e5df24d35`.

Reproduce with:

```sh
python3 tools/evidence/summarize_r1_hrv_timing_start.py
