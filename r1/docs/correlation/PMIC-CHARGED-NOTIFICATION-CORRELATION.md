...
[`../../src/r1_battery.c`](../../src/r1_battery.c).
...
unsigned Nordic SDK image. That image contains 90,956 bytes of text, 236 bytes
of data, and 132,456 bytes of BSS; its standalone BIN is 91,192 bytes. The HEX
...
```sh
python3 scripts/firmware/summarize_r1_pmic_charged_notification.py
