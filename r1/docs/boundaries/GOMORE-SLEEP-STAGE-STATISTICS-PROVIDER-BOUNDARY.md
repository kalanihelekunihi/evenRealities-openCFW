...
GoMore sleep-algorithm closure. Both statistics blocks and their shared lookup dependency are now
source-admitted as transparent C under the owner-authorized reduction. Their historical
classification was `gomore_health_algorithm_candidate` with disposition
`vendor_source_required_not_redistributable`; exact attribution evidence remains preserved here.
...
| --- | ---: | --- | --- |
| `0x00068FD4..<0x0006911A` | 326 | `afa31edc4912f2d02293bdd725b6762bcbb8ee3663e36c6a15e2347f389a7f60` | interval, awake, sleep, and efficiency statistics; source-admitted as `gomore_primitives_sleep_interval_statistics` |
| `0x00069128..<0x000692D6` | 430 | `7602275b0249f68eed4ef03295b1c3ae05adc949d71b71ea9b81f668afbeda0c` | stage fractions, ratios, and durations; source-admitted as `gomore_primitives_sleep_stage_statistics` |
| `0x0006951E..<0x00069546` | 40 | `68704b376c6239caa65d6a5679c08e552872b91e475fa5b93670777d3a83ead4` | timestamp-indexed stage lookup helper; source-admitted as `gomore_primitives_modulo_value_get` |
...
These observations define the provider ABI and validation surface. Under the owner-authorized
reduction, both statistics blocks consume a bounded caller-provided stage stream and reproduce
the documented output contract without opaque bytes. The first block preserves the stock
`-1.0` seven-field invalid sentinel and treats every unknown nonzero stage as sleep.
The sole downstream score leaf at `0x0006778C` is also source-admitted over a typed 19-float
result, preserving every duration/wake/stage band and the exact 540-minute branch hole.
