...
Eleven recovered application functions are exact Nordic nRF5 SDK 17.1.0 buttonless Secure DFU
...
| `0x00052050..<0x00052078` | 40 | `ble_dfu_buttonless_bootloader_start_finalize` | `ble_dfu.c` | `0x0005208C` |
...
The closure has 998 ledger bytes across eleven source identities. One newly resolved function / 100 bytes is removed from the
...
so the ownership ledger records it as an exact manual provenance supplement. It also folded the
independent 40-byte finalize function at `0x00052050` into the prepare wrapper's noncontiguous
inventory row; the exact finalize entry is now a second manual provenance supplement. Ghidra reports
...
- `4664b0bf23c87e88eaa0e743cecc8fef14a88241a3148941443eff0726560b5b`;
