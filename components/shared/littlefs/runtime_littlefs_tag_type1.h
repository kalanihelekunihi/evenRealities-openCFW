 ...
 *
 * Production ABI for an adaptation of littlefs v2.10.1 lfs_tag_type1(). The
 * private upstream lfs_tag_t is exactly uint32_t; this
 * isolated boundary intentionally exposes no other littlefs internals.
 */

#ifndef OPEN_CFW_RUNTIME_LITTLEFS_TAG_TYPE1_H
#define OPEN_CFW_RUNTIME_LITTLEFS_TAG_TYPE1_H

#include <stdint.h>

typedef uint32_t open_cfw_littlefs_type1_tag_t;

_Static_assert(
    sizeof(open_cfw_littlefs_type1_tag_t) == 4U,
