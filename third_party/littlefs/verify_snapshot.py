...
EXPECTED_TAG_ID_MANIFEST_PROVIDERS = {
    "apollo_main": {
        ...
        "size": 3648654,
        "sha256": "36b7f32f9f5f1a4c2fbf800b8cda0f48aa521bfc87638d671932b80b49f7e991",
        "profiles": {
            "linux-clang": {
                "size": 3650478,
                "sha256": "5fe58e3af2a0b7fed55c6b7c33afbd1ac5c887860721b04859e2d49d81be828c",
            },
        },
    },
    "apollo_bootloader": {
...
def verify_production_allowlist() -> None:
    ...
    tag_chunk_components = {
        "components/apollo_main/core_overlay/overlay.json": {
            ...
            "linux_artifact": {
                "overlay_size": 127082,
                "overlay_sha256": "f24cf0e060530429679df9389571ffee397819dfa2c3abc00d26deb75a3e47ad",
                "component_size": 3650478,
                "component_sha256": "5fe58e3af2a0b7fed55c6b7c33afbd1ac5c887860721b04859e2d49d81be828c",
            },
        },
        "components/bootloader/core_overlay/overlay.json": {
            "offset": 622,
    ...
    aggregate_pins = {
        "components/apollo_main/core_overlay/overlay.json": {
            "apple-clang": {
                "overlay_size": 125258,
                "overlay_sha256": "1f71240bd75af28798d93eba217b99464156ee40ae353333c2fd0f449b9a8c76",
                "component_size": 3648654,
                "component_sha256": "36b7f32f9f5f1a4c2fbf800b8cda0f48aa521bfc87638d671932b80b49f7e991",
            },
            "linux-clang": {
                "overlay_size": 127082,
                "overlay_sha256": "f24cf0e060530429679df9389571ffee397819dfa2c3abc00d26deb75a3e47ad",
    ...
    for relative_path, overlay in production_overlays.items():
        ...
        expected_sequence = expected_tail + expected_successors[relative_path]
        require(
            [
                leaf.get("function")
                for leaf in overlay.get("relocated_leaves", [])[-len(expected_sequence):]
            ]
            == expected_sequence,
            f"atomic littlefs scalar tag tail order changed in {relative_path}",
        )
        require(
            list(overlay.get("functions", {}))[-len(expected_sequence):]
            == expected_sequence,
...
def verify_tag_id_manifest() -> None:
    ...
    for component_name, expected_regions in EXPECTED_TAG_ID_MANIFEST_REGIONS.items():
        ...
        require(
            names[-len(expected_tail):] == expected_tail,
