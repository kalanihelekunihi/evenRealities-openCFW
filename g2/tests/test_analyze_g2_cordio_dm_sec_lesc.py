...
class CordioDmSecLescAuditTest(unittest.TestCase):
    ...
    def test_stock_dm_sec_lesc_closure(self):
        ...
        self.assertEqual(r["architecture"]["message_events"],[0x40,0x41]); self.assertEqual(r["readiness"]["linked_unresolved_symbols"],0); self.assertEqual(r["production"]["stock_bytes_replaced"],0)
