...
class ProductionScreenTests(unittest.TestCase):
 ...
 def test_boundary_and_status(self):self.assertEqual(self.r['boundary']['next_function'],'0x005cf8e4');self.assertFalse(self.r['production']['production_routed']);self.assertIsNone(self.r['production']['candidate'])
