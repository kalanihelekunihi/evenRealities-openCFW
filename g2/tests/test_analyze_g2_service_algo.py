...
class G2ServiceAlgoTests(unittest.TestCase):
    ...
    def test_complete_object_surface(self):
        ...
        self.assertEqual(
            ...
            (10, 10, 0, 2, 3, 2, 1712, 1848, 136, 574),
        )
        self.assertEqual(
            (
    ...
    def test_signal_contract_and_short_input_hazard(self):
        b = self.report["behavior"]
        self.assertEqual(b["stereo_frame_count"], 800)
        self.assertEqual(b["required_input_bytes"], 3200)
        self.assertTrue(b["short_aligned_input_is_accepted_but_read_as_3200_bytes"])
