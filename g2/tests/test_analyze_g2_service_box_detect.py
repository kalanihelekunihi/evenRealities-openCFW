...
class ServiceBoxDetectTests(unittest.TestCase):
 ...
 def test_claims(self):
  ...
  self.assertEqual(self.r['production'],{'production_routed':True,'source_functions':34,'compiled_text_bytes':1626,'alignment_bytes':36,'strict_relocations':77,'replaced_stock_body_bytes':3584,'hardware_validation':'blocked by unavailable physical evidence'})
