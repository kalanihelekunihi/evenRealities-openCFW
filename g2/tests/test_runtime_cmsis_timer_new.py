...
class RuntimeCmsisTimerNewTests(unittest.TestCase):
    ...
    def test_production_overlay_and_manifest_admit_callback_and_constructor(self):
        ...
        self.assertEqual(config["expected"]["overlay_size"], 143_227)
        self.assertEqual(config["expected"]["component_size"], 3_666_623)
        self.assertEqual(
        ...
        self.assertEqual(main["provider"]["size"], 3_666_623)
        self.assertEqual(
