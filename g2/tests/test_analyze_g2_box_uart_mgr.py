...
P = Path(__file__).resolve().parents[1] / "tools/analyze_g2_box_uart_mgr.py"
S = importlib.util.spec_from_file_location("g2_box_uart_mgr", P)
...
class ZeroAnchorClosureTests(unittest.TestCase):
    ...
    def test_evidence_and_production(self):
        ...
        self.assertEqual(self.r["production"], {
            ...
            'package_size': 4750576,
            'placed_flash_regions': 7006,
        })
