...
class G2DisplaydrvManagerTests(unittest.TestCase):
 ...
 def test_behavior_and_routing(self):
  ...
  self.assertEqual(self.r['production'],{"production_routed":True,"source_files":5,"guarded_redirects":19,"routed_stock_bytes":2798,"retained_compatibility_bytes":272})
