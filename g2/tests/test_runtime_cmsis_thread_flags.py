...
class RuntimeCmsisThreadFlagsTests(unittest.TestCase):
 ...
 def test_dual_profile_production_admission_is_pinned(self):
  ...
  pins={'open_cfw_freertos_task_notify_wait':((130,195912,'9f84d2c30e86f3a01ef3639e7a54f7cc34d5901d41a0d1b093604a5da4b0117d'),(130,197696,'2a3781baa5f838bfbd5c8b8807056f87f7b8cb5f4452ca2a55cbbe93d2d41062')),'open_cfw_freertos_task_notify':((278,196044,'02cf74a9e713ac13669186e73ca2400776ee7f44212c43fd1418168f2ebc1ca6'),(278,197828,'1c6f5c56310cbb7d4e08567ae8af0f55d426b72ffbfc342e4b57ebe2221c40ba')),'open_cfw_freertos_task_notify_from_isr':((296,196324,'735d6d31d2943c7ac081d80addc65a82df714e96a27cd9c084daf0c1d631083e'),(296,198108,'56f0749b3eccc179ea1855d91b794a6198f7b08345fa0ee28002ec33c2f0644f')),'open_cfw_cmsis_thread_flags_set':((130,196620,'b04f2432b294ea7c0fdb56bf95b63c1ec406e2d8c9ced165b7af450a7f2beaa9'),(132,198404,'570be208aa0d31a84ad7038a9715ac0a67170fa86f841671b41a921739c6f84c')),'open_cfw_cmsis_thread_flags_wait':((186,196752,'2f7b0ad828f7843694a2b0f407fe55d9bf1b9ef798c08238095cae1c0e9367d6'),(186,198536,'87946a64cfbe356e7e46e3cc063df7cbc7c57e75386fd89cbfe075f06a78c4a6'))}
  ...
  manifest=json.loads(MANIFEST.read_text());main=manifest['component_overrides']['apollo_main'];regions={x['name']:x for x in main['regions']};self.assertEqual(tuple(regions[n]['file_offset'] for n in ('apollo_freertos_task_notify_wait_source_leaf','apollo_freertos_task_notify_source_leaf','apollo_freertos_task_notify_from_isr_source_leaf','apollo_cmsis_thread_flags_set_source_leaf','apollo_cmsis_thread_flags_wait_source_leaf')),(3719308,3719440,3719720,3720016,3720148));self.assertEqual((main['provider']['size'],main['provider']['sha256']),(3952454,'d72288b5831087acaff95fc3aaadb9e178b755ee8ce3b64a17be24af1bfd3dcb'));self.assertEqual((main['provider']['profiles']['linux-clang']['size'],main['provider']['profiles']['linux-clang']['sha256']),(3736060,'fc7e2a8363e7d8a78c28c64cbaf7dcc3a03a1089c716d2d83f8d1a9bb5c10b97'));self.assertEqual((manifest['package']['expected_size'],manifest['package']['expected_sha256']),(4745526,'4eb4b7f409e6c7023cffa70b21b2b3646a20f1bf305333cdc57b556b5fc32934'));self.assertEqual((manifest['package']['profiles']['linux-clang']['expected_size'],manifest['package']['profiles']['linux-clang']['expected_sha256']),(4529116,'f0526433c366a85ab79e27df6d28ffc70d6a2ed93e608652885b49b404e380ef'))
