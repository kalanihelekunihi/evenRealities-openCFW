...
P = Path(__file__).resolve().parents[1] / "tools/analyze_g2_system_monitor.py"
S = importlib.util.spec_from_file_location("g2_system_monitor", P)
...
class ZeroAnchorClosureTests(unittest.TestCase):
    ...
    def test_identity(self):
        self.assertEqual(self.r["identity"], {'disposition': 'linked-unanchored', 'ghidra_discovered_functions': 0, 'image_sha256': '36c5b0e499a68ac2493a497bdab9740fd3e7027730c26a9094eca47268a27863', 'path_anchored_functions': 0, 'retained_path': 'app\\gui\\system\\system_monitor.c', 'retained_product_path': 'D:\\01_workspace\\s200_ap510b_iar_git\\app\\gui\\system\\system_monitor.c'})

    def test_surface(self):
        self.assertEqual(self.r["surface"], {'body_bytes': 510, 'direct_body_calls': 44, 'function_escapes': 0, 'indirect_body_calls': 0, 'internal_direct_body_calls': 0, 'linked_functions': 1, 'outer_pool_bytes': 82, 'path_literal_references': 6, 'physical_bytes': 592, 'raw_path_referencing_functions': 1, 'reachable_instructions': 198})
