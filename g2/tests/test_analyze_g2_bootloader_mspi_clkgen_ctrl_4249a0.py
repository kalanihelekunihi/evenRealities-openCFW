...
class Tests(unittest.TestCase):
 ...
 def test_audit(s):
  r=analyzer.audit();s.assertTrue(r["production"]["routed"]);s.assertEqual(r["production"]["source_owned_bytes"]+r["production"]["retained_official_bytes"],146994);s.assertEqual(r["production"]["next_frontier"],0x424A5A);s.assertEqual(r["hardware_validation"],"blocked by unavailable physical evidence")
