#!/usr/bin/env python3
"""Guard the bounded G2 Cordio SMP SC responder-action evidence."""
...
class SmprScActTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        path = ROOT / "tools/analyze_g2_cordio_smpr_sc_act.py"
        spec = importlib.util.spec_from_file_location("analyze_g2_cordio_smpr_sc_act", path)
    ...
    def test_closure(self) -> None:
        ...
        self.assertEqual(module["linked_function_bytes"], 1162)
        self.assertEqual(module["owned_noncode_bytes"], 34)
        self.assertEqual(module["physical_bytes"], 1196)
