...
class BleTransportProfileTests(unittest.TestCase):
 ...
 def test_complete_partition(self):self.assertEqual(self.r['aggregate'],{'modules':4,'linked_functions':21,'body_bytes':2374,'physical_bytes':3000,'production_routed':False});self.assertEqual(set(self.r['modules']),{'eus','ess','efs','nus'})
 ...
 def test_not_production_admitted(self):self.assertEqual(self.r['production'],{'source_admitted':False,'production_routed':False,'ownership_bytes':0})
