 ...
 *
 * Maintained G2 lifecycle boundary for FreeType 2.9.1.
 * See third_party/freetype/LICENSE for the FreeType Project License.
 */

#ifndef OPEN_CFW_RUNTIME_FREETYPE_BASE_H
#define OPEN_CFW_RUNTIME_FREETYPE_BASE_H
...
struct open_cfw_freetype_base_state {
    FT_Memory memory;
    FT_Library library;
...
#define OPEN_CFW_FREETYPE_BASE_INIT { 0 }

/*
 * Recreates the recovered G2 sequence.  state must be initialized with
 * OPEN_CFW_FREETYPE_BASE_INIT before its first call:
 ...
 * FT_Done_FreeType entry; this state deliberately uses FT_Done_Library
