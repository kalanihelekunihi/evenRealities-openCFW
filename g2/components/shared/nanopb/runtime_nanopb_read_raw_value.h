 ...
 *
 * Altered production compatibility ABI for nanopb read_raw_value().
 */

#ifndef OPEN_CFW_RUNTIME_NANOPB_READ_RAW_VALUE_H
#define OPEN_CFW_RUNTIME_NANOPB_READ_RAW_VALUE_H
...
#endif /* OPEN_CFW_RUNTIME_NANOPB_READ_RAW_VALUE_H */
