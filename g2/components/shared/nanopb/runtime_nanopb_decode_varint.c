 ...
 *
 * Altered production source for nanopb pb_decode_varint(). The selected source
 ...
 *
 * The G2 stock body occupies [0x0048F5B8, 0x0048F628). The production overlay
 * binds its read-byte call to the stable, source-backed entry at 0x0048F454.
 */
