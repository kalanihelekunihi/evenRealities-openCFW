 ...
 *
 * Altered production source for nanopb pb_skip_field(). The selected baseline
 * is authenticated nanopb 0.4.9 commit
 * 98bf4db69897b53434f3d0ba72e0a3ab1a902824. Binary evidence establishes a
 * pristine-runtime compatibility interval of 0.4.7--0.4.9, not the vendor's
 * exact historical point release.
 *
 * The complete stock body occupies [0x0048F6A0, 0x0048F6EA). Every executable
 * dependency binds directly to a separately source-owned nanopb leaf. The
 * diagnostic is source-owned read-only data and preserves upstream's
