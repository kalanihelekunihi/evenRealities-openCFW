 ...
 *
 * Production openCFW compatibility ABI for nanopb's pb_skip_varint(). This is
 * altered source, not pristine upstream source and not proof of the vendor's
 * historical nanopb point release.
 */

#ifndef OPEN_CFW_RUNTIME_NANOPB_SKIP_VARINT_H
#define OPEN_CFW_RUNTIME_NANOPB_SKIP_VARINT_H

#include "runtime_nanopb_decode_varint.h"

enum {
    OPEN_CFW_NANOPB_READ_ADDRESS = 0x0048F3BEU
};
