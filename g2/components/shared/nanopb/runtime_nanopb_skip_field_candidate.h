 ...
 *
 * Production-excluded compatibility ABI for nanopb pb_skip_field().
 */

#ifndef OPEN_CFW_RUNTIME_NANOPB_SKIP_FIELD_CANDIDATE_H
#define OPEN_CFW_RUNTIME_NANOPB_SKIP_FIELD_CANDIDATE_H
...
#endif /* OPEN_CFW_RUNTIME_NANOPB_SKIP_FIELD_CANDIDATE_H */
