 ...
 *
 * Nonproduction Apollo-main ABI for the authenticated EasyLogger
 * elog_hexdump() source candidate. This header is intentionally absent from
 * every production overlay and firmware manifest.
 */

#ifndef OPEN_CFW_RUNTIME_EASYLOGGER_HEXDUMP_CANDIDATE_H
#define OPEN_CFW_RUNTIME_EASYLOGGER_HEXDUMP_CANDIDATE_H
...
#define OPEN_CFW_EASYLOGGER_HEXDUMP_FILL(destination, count, value) \
    open_cfw_easylogger_hexdump_fill_source((destination), (count), (value))
#endif
...
#define OPEN_CFW_EASYLOGGER_HEXDUMP_FORMAT_HEX(buffer, value) \
    open_cfw_easylogger_hexdump_format_hex_source((buffer), (value))
#endif

#ifndef OPEN_CFW_EASYLOGGER_HEXDUMP_FORMAT_CHARACTER
#define OPEN_CFW_EASYLOGGER_HEXDUMP_FORMAT_CHARACTER(buffer, value) \
    open_cfw_easylogger_hexdump_format_character_source((buffer), (value))
#endif
