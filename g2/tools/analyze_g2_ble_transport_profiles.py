...
PINS={FUNCTION_MAP:'a31155ed0cbe4e73267115dc78a7f8fcc30081f44bf601608b0ace2646a9f989',CLOSURE:'0f3497001a0d36ad8914d622a763b66e0cb7b81db0c7a0febdf3c2c50cd72c2b',PROVENANCE:'04195186e93bb9e256e5d9ef3a3bbfd0a9c6b379ffcc37844ab0aedcbfa2ee1d'}
...
LEAF_DIGEST='8a0c73af02c5eea016485c529b8af48659478b99812905b5d3d84f9a890f0ee0';PATCH_DIGEST='c58513379fe11707c31e2b28ada7800d770a8116ea0487204accbbf059ac78a4';BUILT_DIGEST='02114a792d30ee5c83d3978ba5cc779b8564113ef9659e36a20d23120c5d8da8';REGION_DIGEST='fa53e00885151fe72712908d7ee0e5dc4db2958ddd232ed06452b7b65471236f'
MODULES={
...
def analyze(image:Path=IMAGE)->dict[str,Any]:
 ...
 if (build['overlay']['size'],build['overlay']['sha256'],build['component']['size'],build['component']['sha256'])!=(240692,'2db11ff707bf253280eb07667c3d76954347cc9e31796c7589faf788fed629ae',3764088,'b3ee7d2fb560f134bd5c4a27eb8203abdc0dd9482816319be0b03320fc2067ed'):raise AuditError('production BLE transport-profile build pins changed')
 ...
 if (len(plan_bytes),sha(plan_bytes))!=(2588615,'bfdbc3b09c31f281cabb3b31b95f80523c7cfdd62edc83677f5f9adc50aac60f') or plan.get('package_sha256')!='275a9e691c0bad851f7adbc80ed2abc1580e13d67f031912e198f984d18f7f85' or tuple(len(plan[k]) for k in ('flash_regions','unresolved_flash_regions','container_only_regions','protected_regions'))!=(3715,2,5,6):raise AuditError('production BLE transport-profile flash plan changed')
