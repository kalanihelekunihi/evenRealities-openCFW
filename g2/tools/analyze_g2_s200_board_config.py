...
PINS = {FM: "654e62f72051ac138d462dbcbf44be1bdf1c84b5ea767f499310b67c25c3db54", CL: "c7607f5d1b6f5d92be97cb1d63d37b400cedcb0bcf8bfdd968b44cd86ce1a66d"}
...
EXPECTED = {'body_bytes': 118, 'body_concat_sha256': '27a44e873d5bb0e861215e0690f7cd5853b5421d19258a1e1a348dda9206290d', 'reachable_instructions': 48, 'reachable_instruction_digest': 'fa1b27b526cd5e7edebda71de22eed41a964a3794508d69c1391fd0618549692', 'direct_body_calls': 9, 'direct_body_call_digest': 'ae365f6bd941a82a89941f6d03a82e595564fb00caaaeca46daf00b3a894e3f2', 'internal_direct_body_calls': 0, 'outer_pool_bytes': 582, 'outer_pool_sha256': 'f3d77dec7ec2b0e34025dfd75b0fd1bced55c3e13c2f8990f0bd2a32ee85021f', 'physical_bytes': 700, 'physical_sha256': 'befcd26e00da296f7ce7e4e7177a0f686ae9854e8cf437d859f2d5ff75f1f4c3', 'path_literal_references': 1}
...
def analyze(image=IMAGE):
    ...
    if any(x.get("path", "").replace("\\", "/").split("/")[-1].lower() == 'board_config.c' for x in overlay["sources"]):
