...
def analyze(image=IMAGE):
 ...
 if len(source)!=13914 or sh(source)!='31704fa9e1a3243bfe388c3e43873d640e72a13044fa3fd24219b51a57fd52d9':raise c.AuditError('production OTA transport source changed')
