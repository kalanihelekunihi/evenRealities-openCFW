...
PINS={FM:'8ca8cf7a770d279caa9a01bfddf4c0b7c73eb56224fde9b93ac41fd50bd2dcbc',PM:'5caf3a01a4ea5da99a02ab490cd915f46a4392b035fbf38f833a8fc95456a6cd',CL:'cade5d8c19d5087d0ed9aad0ea3720bbf93e3e8f8af91d6ce0958f36e40cad51'}
...
def analyze(image=IMAGE):
 ...
 expected_regions={'ota_transport_01_source_replacement':(0x48D8D8,1384,'generated_source_entry_replacement'),'ota_transport_02_source_replacement':(0x48DE40,616,'generated_source_entry_replacement'),'ota_transport_03_source_replacement':(0x48E0A8,4,'generated_source_entry_replacement'),'ota_transport_retained_pool':(0x48E0AC,288,'official_blob'),'ota_transport_source_alignment':(0x7D71EA,2,'generated_alignment'),'ota_transport_receive_source_text':(0x7D71EC,704,'source_compiled'),'ota_transport_send_source_text':(0x7D74AC,584,'source_compiled'),'ota_transport_state_source_text':(0x7D76F4,12,'source_compiled')}
