...
def audit() -> dict:
    ...
    require(component["source_owned_bytes"] == 1849, "source accounting changed")
    require(component["generated_patch_site_bytes"] == 2398, "patch accounting changed")
    require(component["generated_alignment_bytes"] == 8, "alignment accounting changed")
    require(component["opaque_base_bytes"] == 146201, "retained accounting changed")
