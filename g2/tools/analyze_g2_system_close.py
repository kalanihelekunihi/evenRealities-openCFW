...
PINS={FM:'367d349f69f33c0d3bbc9c8a72548b63dcf0648df1d2e3491a70b53eb68f47e1',PM:'7d2d13107465ee484fdca0d63434257c2f6d8533f534ff0fc2d959e8e847bfed',CL:'40b61f2a2d8f2d34c89a3cf1dcdfef1e72cd8da5f9616808b1ab97c945d037d7'}
SOURCE_PATH='components/apollo_main/core_overlay/system_close.c';SOURCE_PIN=(35394,'5597710a9c73dd8b542c793882b302708afaa46937601cf15e8ca301a3cfc4d0')
...
LEAF_DIGEST='f5f897d37bfc0c6c4af029e9a10d85543e63396f172cf1d6b63bb686394dd039';PATCH_DIGEST='004cb946fa5723a6505b706f20ad27443e7fe98ebb67713c08ce140a1685b64a';BUILT_DIGEST='84164ade8395cc9a375a652335ce393e905f5b3655542788c88c770acaaed8c6';REGION_DIGEST='62577877012d8b2ff3f163be22e049029d91513714fc896e9829871f93175cb4'
...
def analyze(image=IMAGE):
 ...
 if any(x.get('profiles')!=['apple-clang'] or not x.get('strict_relocation_contract') or x.get('source',{}).get('license')!='GPL-3.0-only' for x in leaves):raise c.AuditError('production SystemClose leaf policy changed')
 ...
 previous=285244;alignment=0
 for leaf in leaves:
  alignment+=leaf['expected']['offset']-previous;previous=leaf['expected']['offset']+leaf['expected']['size']
 if alignment!=22 or previous!=288070:raise c.AuditError('production SystemClose placement changed')
 ...
 if (build['overlay']['size'],build['overlay']['sha256'],build['component']['size'],build['component']['sha256'])!=(332148,'588a29c8d680068b6f27dd2cff831dcfd5aa71a91e4f9f97537d9bcb4a0d145d',3855544,'df6d3b4d5aeffa8e7341937d0d72e3425a6dacfc8fa964cf2b2cda9995079bdc'):raise c.AuditError('production SystemClose build pins changed')
