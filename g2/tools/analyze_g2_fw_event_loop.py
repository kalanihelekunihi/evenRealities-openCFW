...
def analyze(image=IMAGE):
 ...
 if source is None or source.get('sha256')!='e1ac9d2f18f411d712b771a3b698c89de9a340843bc26294e629e14b6e915ccc' or sh((ROOT/source['path']).read_bytes())!=source['sha256']:raise c.AuditError('production source route changed')
