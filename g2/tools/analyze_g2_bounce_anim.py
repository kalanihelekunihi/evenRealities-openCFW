#!/usr/bin/env python3
"""Fail-closed zero-anchor linked-object audit for app\\gui\\anim\\bounce_anim.c."""
import csv
import hashlib
import json
import struct
...
FM = ROOT / "tools/manifests/g2-bounce-anim-function-map.tsv"
CL = ROOT / "tools/manifests/g2-bounce-anim-closure.tsv"
PINS = {FM: "b423eac380ef9b78b0de21cf2bd129e52147bc2ad3e6f56d917a8e9d5129502a", CL: "b7c2cc320c32c5fd27063dff1e0849fc37829dcc626d009a5359ce9a27a963cc"}
RETAINED = 'app\\gui\\anim\\bounce_anim.c'
FULL_PATH = 'D:\\01_workspace\\s200_ap510b_iar_git\\app\\gui\\anim\\bounce_anim.c'
PATH_RUN = 0x7097a4
CELLS = (5810272,)
CELL_REFS = {5810272: (5809202, 5809286, 5809354, 5809514, 5809606, 5809678, 5809736, 5809828, 5809944, 5810084, 5810196)}
ALL_REFS = (5809202, 5809286, 5809354, 5809514, 5809606, 5809678, 5809736, 5809828, 5809944, 5810084, 5810196)
F = ((5809148, 5809160), (5809160, 5809558), (5809560, 5809572), (5809572, 5809792), (5809792, 5810130), (5810130, 5810238), (5810238, 5810264))
PHYS = (5809148, 5810400)
FOREIGN = ()
ESCAPES = ()
INDIRECT = (5809784,)
BL_ENTRY = ((5590714, 5810238), (5590780, 5810238), (5595462, 5809792), (5595800, 5809792), (5809870, 5810130), (5974666, 5809792), (5974680, 5809792))
BL_STRICT = ()
BW_ENTRY = ()
B16_ENTRY = ()
STORED_RAW = ((5810372, 5809149), (5810376, 5809161))
GUARD_BEFORE = "b2ab59fe6314162b3d2a60d51a4c9d68197c8010f4a8c8b58e57146c58c7482a"
GUARD_AFTER = "59e4e8b251be1766cee0f8d48d9a2065c789d0bc02594e9107b1c53dd96ac05c"
TAGS = ((7207044, '[bounce.anim]Starting bounce animation: direction=%s, distance=%dpx, total_duration=%dms'), (7342572, '[bounce.anim]phase1_ready_cb: animation was stopped, cleaning up'), (7342640, '[bounce.anim]phase2_ready_cb: animation was stopped, cleaning up'), (7456176, '[bounce.anim]Phase 2 animation started: duration=%dms'), (7456232, '[bounce.anim]Phase 1 animation started: duration=%dms'), (7500548, '[bounce.anim]Phase 1 completed, starting phase 2'), (7500652, '[bounce.anim]Bounce animation stopped for obj=%p'), (7544196, '[bounce.anim]phase1_ready_cb: invalid context'), (7544244, '[bounce.anim]phase2_ready_cb: invalid context'), (7634636, '[bounce.anim]Bounce animation completed'), (7773928, '[bounce.anim]obj is NULL'))
EXPECTED = {'body_bytes': 1114, 'body_concat_sha256': '4fdc23ee6169ac4b3d70a13e07a3e581366d75456ae16536dc0ad7018b6106da', 'reachable_instructions': 451, 'reachable_instruction_digest': '3ce14752cadd1f2ecf7163b20108b3576d8a24de78d8ad3d4aeeb63504de5849', 'direct_body_calls': 67, 'direct_body_call_digest': '166a699257e35947966b9a2685181f7c7c7ec61b4cacc5583a6eb8f2130cb70b', 'internal_direct_body_calls': 1, 'outer_pool_bytes': 138, 'outer_pool_sha256': 'cf066894351fe6eba85895079ac087ecb0668cc925774f9c1ccda50858dd8bb7', 'physical_bytes': 1252, 'physical_sha256': '3ac4d3b625dbbee0518aad6fa5fcb5b3b100d0af714f97c825b0013aa38fc956', 'path_literal_references': 11}
...
def analyze(image=IMAGE):
    ...
    if any(x.get("path", "").replace("\\", "/").split("/")[-1].lower() == 'bounce_anim.c' for x in overlay["sources"]):
