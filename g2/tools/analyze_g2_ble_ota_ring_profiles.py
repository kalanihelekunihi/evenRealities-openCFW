...
def analyze(image=IMAGE):
 ...
 ring_retained={x.get('name'):x for x in main['regions'] if x.get('name') in {'apollo_opaque_before_ring_profile','opaque_ring_profile_literal_pool','apollo_opaque_after_ring_profile_before_littlefs_utilities'}};ring_expected_retained={'apollo_opaque_before_ring_profile':(4989966,8882,'official_blob'),'opaque_ring_profile_literal_pool':(5000294,134,'official_blob'),'apollo_opaque_after_ring_profile_before_littlefs_utilities':(5000428,23052,'official_blob')}
