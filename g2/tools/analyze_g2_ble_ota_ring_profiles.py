...
PINS={FM:'73e7ffba7d60c2f495cb87745d9d996071a3ab0b490d30ac49cb5c1018904098',CLOSURE:'674f9b808ff75e507ca683c4702c0a2c4c9f7c3a0ce785f82f4b4e6bfa800528',PROV:'bdcfac1f9e0020996dfba6bc7b9eb77ea46bb585562a4e3d15c7bb91b68ffbb0',VERIFY:'5940da878e18ace5112bbfac0874ebda42664601098aec115a705b9572f019c5',PROD_PROV:'83ac5589302dcccab6af37611fd35d48b42118f6239645a0a47c8fd2b12e8d18',RING_PROV:'3b88c943c4ae2edf411e4c1a5e52ea5b34f3fc04aad91bbca97e7908a532ee75'}
MODULES={
...
LEAF_DIGEST='e152b2170194605ca1c6730b57cd34a503499dea1b4dabc0756dde3a4362a0f0';PATCH_DIGEST='0ae9d699f04930a83ec320bd88b5cc6c216a22e0f1ed27fe13fb5e35f444fb7d';BUILT_DIGEST='f1096096c4ab4ab734deb99f2792fe42b0b71ebab110237e93fc6ef9a42419e1';REGION_DIGEST='848baf6cda052f69c74e9992dd0b69a2621deb71dcadf4befff06fbe235f347b'
RING_SOURCE_PIN=(14172,'a114dbe5e50bb31d63ffcde32af7dfdea26c827c9e88d1e03d3a5a21ff66543f');RING_LEAF_NAMES=('open_cfw_ring_pack_ccc_epoch','open_cfw_ring_enable_ccc','open_cfw_ring_handler_init','open_cfw_ring_service_discover','open_cfw_ring_receive_data','open_cfw_ring_process_message','open_cfw_ring_send_data')
RING_LEAF_DIGEST='04622d101a2a57421a0792bd3bfe4d7faa342d4ce0ac9e6271a9d6f602c47f1d';RING_PATCH_DIGEST='0c67f235ffb2526f8cca1f1040b953a2bb0b1589cc77be63092999bb61d537d2';RING_BUILT_DIGEST='bb757b379eacee85a03afe31cc997e367465921024199d8703cbd75aef8778db';RING_REGION_DIGEST='953ea24bb90f3a9b8ad983978670aaa8ef04887da371c2bdda692518ebfe1022'
...
def analyze(image=IMAGE):
 ...
 previous=251676;alignment=0
 for leaf in leaves:alignment+=leaf['expected']['offset']-previous;previous=leaf['expected']['offset']+leaf['expected']['size']
 if alignment!=8 or previous!=252060:raise AuditError('production BLE OTA placement changed')
 ...
 if (build['overlay']['size'],build['overlay']['sha256'],build['component']['size'],build['component']['sha256'])!=(332148,'588a29c8d680068b6f27dd2cff831dcfd5aa71a91e4f9f97537d9bcb4a0d145d',3855544,'df6d3b4d5aeffa8e7341937d0d72e3425a6dacfc8fa964cf2b2cda9995079bdc'):raise AuditError('production BLE OTA build pins changed')
 ...
 if any(x.get('profiles')!=['apple-clang'] or not x.get('strict_relocation_contract') or x.get('source',{}).get('license')!='GPL-3.0-only' for x in ring_leaves):raise AuditError('production BLE Ring leaf policy changed')
 ...
 previous=252060;alignment=0
 for leaf in ring_leaves:alignment+=leaf['expected']['offset']-previous;previous=leaf['expected']['offset']+leaf['expected']['size']
 if alignment!=8 or previous!=252700:raise AuditError('production BLE Ring placement changed')
