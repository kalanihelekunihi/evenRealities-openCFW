...
def analyze(image=IMAGE):
 ...
 if (len(source_bytes),sh(source_bytes))!=(1782,"4a49c2ade008eb3e2004cfd8e61e4632a517ac4c8e68eb101ce11a7b275c2a2a"):raise c.AuditError("OPT3007 production source changed")
