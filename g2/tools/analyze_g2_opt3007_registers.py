...
def analyze(image=IMAGE):
 ...
 if (build["overlay"]["size"],build["overlay"]["sha256"],build["component"]["size"],build["component"]["sha256"])!=(332148,"588a29c8d680068b6f27dd2cff831dcfd5aa71a91e4f9f97537d9bcb4a0d145d",3855544,"df6d3b4d5aeffa8e7341937d0d72e3425a6dacfc8fa964cf2b2cda9995079bdc"):raise c.AuditError("OPT3007 production build pins changed")
 ...
 if (len(package_bytes),sh(package_bytes))!=(4634038,manifest["package"]["expected_sha256"]):raise c.AuditError("OPT3007 package artifact changed")
 plan_bytes=FLASH_PLAN.read_bytes();plan=json.loads(plan_bytes)
 if (len(plan_bytes),sh(plan_bytes),plan.get("package_sha256"),tuple(len(plan[key]) for key in ("flash_regions","unresolved_flash_regions","container_only_regions","protected_regions")))!=(3108201,"e91992690cb5766623f0b95b0928d3113ea9c0deac6d12275d55db6f12741297","3953d7a537b11d75c7f589522ae7958bd7c4f59a15d35b98d92d5bec79b90731",(4482,2,5,6)):raise c.AuditError("OPT3007 flash plan changed")
