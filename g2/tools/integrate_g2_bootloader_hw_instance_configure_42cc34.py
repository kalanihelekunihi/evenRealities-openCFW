#!/usr/bin/env python3
"""Register the source-owned hardware instance configurator."""
...
S = R / "components/bootloader/core_overlay/runtime_hw_instance_configure_42cc34.c"
B = R / "blobs/official/g2-2.2.6.10/ota_s200_bootloader.bin"
C = R / "tools/manifests/g2-bootloader-post-mspi-frontier.tsv"
BASE = 0x410000
SS = 5381
SH = "b5a353aff34adf56192017a1cb1f1ac0844476a69162e9725061f29217975eb9"
FN = "open_cfw_bootloader_hw_instance_configure_42cc34"
A = 0x42CC34
Z = 0x42CDB0
BH = "d881da0882c4dcc9f1385402b877bcb3d8c379de014c78707c8db99f5b03aa93"
UH = "cd9cd51d75de4bf4ffa5587acfeab18036746f59f4c60d9b5c2ce91edac3f631"
FL = [
...
RS = ((0x07C, "open_cfw_bootloader_hw_clock_encode_42c26a", 0x42C26A),)
...
def main() -> int:
    ...
    if (len(source), sha(source)) != (SS, SH):
        raise SystemExit("hardware-instance configurator source changed")
    if sha(boot[A - BASE:Z - BASE]) != BH:
        raise SystemExit("hardware-instance configurator stock body changed")
    record = {
        "path": S.relative_to(R).as_posix(), "size": SS, "sha256": SH,
        "license": "MIT",
        "origin": "clean-room hardware instance validation and mode configuration",
        "evidence": "docs/research/g2-bootloader-hw-instance-configure-42cc34-source-closure.md",
    }
    relocations = [
    ...
    if row is None or int(row["end"], 16) != Z:
        raise SystemExit("hardware-instance configurator census changed")
    row.update({
        "kind": "source_function", "name": "hw_instance_configure_42cc34",
        "disposition": "source_owned_production",
        "provider": "clean-room hardware instance configurator",
        "license_status": "MIT",
    ...
    print("registered hardware instance configurator")
    return 0
