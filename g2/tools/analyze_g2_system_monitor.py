#!/usr/bin/env python3
"""Fail-closed zero-anchor linked-object audit for app\\gui\\system\\system_monitor.c."""
import csv
import hashlib
import json
import struct
...
FM = ROOT / "tools/manifests/g2-system-monitor-function-map.tsv"
CL = ROOT / "tools/manifests/g2-system-monitor-closure.tsv"
PINS = {FM: "d55d118073e2513f1073c343cc330bc3b91f7e00cd38736d292545b19268aab8", CL: "f91cb16eb47066893e9d398177291ade7602d65b3eb030998d07528d254b2584"}
RETAINED = 'app\\gui\\system\\system_monitor.c'
FULL_PATH = 'D:\\01_workspace\\s200_ap510b_iar_git\\app\\gui\\system\\system_monitor.c'
PATH_RUN = 0x706590
CELLS = (5787884,)
CELL_REFS = {5787884: (5787394, 5787508, 5787572, 5787636, 5787710, 5787806)}
ALL_REFS = (5787394, 5787508, 5787572, 5787636, 5787710, 5787806)
F = ((5787364, 5787874),)
PHYS = (5787364, 5787956)
FOREIGN = ()
ESCAPES = ()
INDIRECT = ()
BL_ENTRY = ()
...
BW_ENTRY = ()
B16_ENTRY = ()
STORED_RAW = ((6964852, 5787365),)
GUARD_BEFORE = "67dcec3a217325979530cc68bbd7aa3fcac897c2415ad3dad4a3af627b9f51ae"
GUARD_AFTER = "88d23584940887944273ef28fd1bd7e328c821754632ed3f23e6970d888ab57b"
TAGS = ((7183020, '[system_monitor]system_monitor_common_data_handler: master role, send idle command to schedule manager'), (7274152, '[system_monitor]system_monitor_common_data_handler: eventType = %d, len = %d'), (7274232, '[system_monitor]system_monitor_common_data_handler: foreground app is running'), (7274312, '[system_monitor]system_monitor_common_data_handler: background app is running'), (7329812, '[system_monitor]system_monitor_common_data_handler: display is running'), (7404132, '[system_monitor]system_monitor_common_data_handler: peer reboot'))
EXPECTED = {'body_bytes': 510, 'body_concat_sha256': '2ca72e1b082381cb08e164e02fdb35c0551337dfb70f034af9c8e0dc95e0fddd', 'reachable_instructions': 198, 'reachable_instruction_digest': '50a5bff7f7c59cd25d59b16124774ee15c96699a2e0b97714ccfb2c57a614887', 'direct_body_calls': 44, 'direct_body_call_digest': '1218544e4791201a13f208f4246078fec380e40a863c060f4b87a295897efa27', 'internal_direct_body_calls': 0, 'outer_pool_bytes': 82, 'outer_pool_sha256': '9aed89f940f713a497304ea67baf643525fd7a134c9f8765a262ad9dd16704c8', 'physical_bytes': 592, 'physical_sha256': '9796cba44d61984b788a7ae57ba4eebf51354960c97c9811543fd9ca602bcb76', 'path_literal_references': 6}
