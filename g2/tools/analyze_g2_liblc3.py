...
SETUP_PRIMARY={"start":0x0059123A,"end_exclusive":0x00591374,"bytes":314,"sha256":"04f7f722ef30afdfae612d0f6622cb4811918c8a8f4dc30b1ee99f95f42572c8"}
SETUP_WRAPPER={"start":0x00591374,"end_exclusive":0x0059138A,"bytes":22,"sha256":"98ecf298571e96939bfefd863c514116a4e5ccf638b8023c395a465175da635d","callsite":0x00591382,"target":0x0059123A}
...
def analyze(image=IMAGE):
 ...
 primary=c._slice(b,SETUP_PRIMARY["start"],SETUP_PRIMARY["end_exclusive"])
 if len(primary)!=SETUP_PRIMARY["bytes"] or sh(primary)!=SETUP_PRIMARY["sha256"]:raise c.AuditError("setup primary span changed")
 wrapper=c._slice(b,SETUP_WRAPPER["start"],SETUP_WRAPPER["end_exclusive"])
 if len(wrapper)!=SETUP_WRAPPER["bytes"] or sh(wrapper)!=SETUP_WRAPPER["sha256"]:raise c.AuditError("setup wrapper span changed")
 ...
 ii,cc,ind=q._recover_function(b,SETUP_WRAPPER["start"],SETUP_WRAPPER["end_exclusive"])
 if len(ii)!=10 or cc!=[(SETUP_WRAPPER["callsite"],SETUP_WRAPPER["target"])] or ind:raise c.AuditError("setup wrapper changed")
