#!/usr/bin/env python3
"""Fail-closed zero-anchor linked-object audit for app\\gui\\AgingTest\\aging_test.c."""
import csv
import hashlib
import json
import struct
...
FM = ROOT / "tools/manifests/g2-aging-test-function-map.tsv"
CL = ROOT / "tools/manifests/g2-aging-test-closure.tsv"
PINS = {FM: "051149102498f9fe5e05850607364716e7ec1eabf7cdaf9ff0b9bae4b921b8d0", CL: "5e7edd7a2679da499fb73f0664f7413369fd26ad98c0af69382c3e3519cc50a0"}
RETAINED = 'app\\gui\\AgingTest\\aging_test.c'
FULL_PATH = 'D:\\01_workspace\\s200_ap510b_iar_git\\app\\gui\\AgingTest\\aging_test.c'
PATH_RUN = 0x6ff794
CELLS = (4441952,)
CELL_REFS = {4441952: (4441116, 4441192, 4441266, 4441336, 4441408, 4441628, 4441766, 4441892)}
ALL_REFS = (4441116, 4441192, 4441266, 4441336, 4441408, 4441628, 4441766, 4441892)
F = ((4441088, 4441168), (4441168, 4441238), (4441238, 4441590), (4441590, 4441806), (4441806, 4441944))
PHYS = (4441088, 4442060)
FOREIGN = ()
ESCAPES = ()
INDIRECT = ()
BL_ENTRY = ((4441544, 4441590), (4441580, 4441806), (4441818, 4441590))
BL_STRICT = ()
BW_ENTRY = ()
B16_ENTRY = ()
STORED_RAW = ((6964404, 4441089), (6964408, 4441239))
GUARD_BEFORE = "b521c0f812c4cf515afbe1c1b2c995bfc688c0b17be674b20a18fe7fa7c86f7a"
GUARD_AFTER = "bb70a5c2175db615e18061c3a317a755e168b1e48793ca251014b7e51b7e5926"
TAGS = ((7412900, '[aging_test]AgingTest_ui_event_handler UI_EVENT_TYPE_INIT'), (7583604, '[aging_test]AgingTest recv data len = %d'), (7722096, '[aging_test]received event: %d'))
EXPECTED = {'body_bytes': 856, 'body_concat_sha256': '13904b1afbb4bddbe81f053e0705385f64c55e13bff4f6d3d4c35327007e73b8', 'reachable_instructions': 345, 'reachable_instruction_digest': 'ebb3e37ecf98f59e295ed0a5f26617e8e7add6da12cb6795a75aca47bf1b8944', 'direct_body_calls': 60, 'direct_body_call_digest': 'ff271c9586796b408489e98a836912b742811ad9d6ab806c49637cb69d0927d9', 'internal_direct_body_calls': 3, 'outer_pool_bytes': 116, 'outer_pool_sha256': '752734bb4b9d6211bbba20caba201451e98cd4318b7d74d56c2cfa85ca710972', 'physical_bytes': 972, 'physical_sha256': 'bb6a644b9b9e9ef5d89626ca0720c39bb86d075278d8fef20b62702832e5807d', 'path_literal_references': 8}
...
def analyze(image=IMAGE):
    ...
    if any(x.get("path", "").replace("\\", "/").split("/")[-1].lower() == 'aging_test.c' for x in overlay["sources"]):
