#!/usr/bin/env python3
"""Register the source-owned retained hardware-event apply service."""
from __future__ import annotations
import csv,hashlib,io,json
from pathlib import Path
R=Path(__file__).resolve().parent.parent;O=R/"components/bootloader/core_overlay/overlay.json";S=R/"components/bootloader/core_overlay/runtime_hw_event_apply_42c0b2.c";B=R/"blobs/official/g2-2.2.6.10/ota_s200_bootloader.bin";C=R/"tools/manifests/g2-bootloader-post-mspi-frontier.tsv";BASE=0x410000;A=0x42C0B2;Z=0x42C222
SS=4805;SH="9f70f0eb351205a28b85e53f96a4d51fa473ea7a4f6ced845082486234bb01bb";FN="open_cfw_bootloader_hw_event_apply_42c0b2";BH="a3d5075b7f480a21b071c587bb343466ca39d411ed426927e82b22168591937e";UH="d6834d461bd966d94e411a233499545d78421cec37e7901ba6e084eb4bbede2d"
...
def main():
 ...
 if row is None or int(row["end"],16)!=Z:raise SystemExit("hardware-event apply census changed")
 row.update({"kind":"source_function","name":"hw_event_apply_42c0b2","disposition":"source_owned_production","provider":"clean-room retained hardware-event apply service","license_status":"MIT","evidence":"exact dual-toolchain body with portable behavioral model"});out=io.StringIO(newline="");w=csv.DictWriter(out,fieldnames=fields,delimiter="\t",lineterminator="\n");w.writeheader();w.writerows(rows);C.write_text(out.getvalue());print("registered hardware-event apply service");return 0
