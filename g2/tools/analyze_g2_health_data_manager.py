...
def analyze(image=IMAGE):
 ...
 if (report["overlay"]["size"],report["overlay"]["sha256"],report["component"]["size"],report["component"]["sha256"])!=(197488,"a4c7927efe625a95e3bd928e5bb75b32c057837577dd9b9bf0cc3a5c19a42183",3720884,"026ba2cc0c5f4dd5ca052b630edd3bbbae8addd95b53f7bd0b16c0ebb40c316a"):raise c.AuditError("production build pins changed")
 ...
 appended=[x for x in regions if x.get("address_status")=="source_compiled" and 8129596<=x.get("target_address",0)<8130618]
