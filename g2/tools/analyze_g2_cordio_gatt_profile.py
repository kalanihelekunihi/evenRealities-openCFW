...
PINS={FM:'9a504dc8f06d9a00d9565cd516235d446a495d397feda90f661a739b87f44094',CLOSURE:'bd16788cef90056d2324f4b84ab1c1f1bdae623fc43f17ea24ec1f5e25206936',PROV:'5733291283feec2543b8ac9d4b7fdb360107d81b2adff70e47fae2b7bbb011f9',VERIFY:'0adce5f9ff0c0b107066c370657eb9a19de8ca71f29e4b37751cfdc77a74151e',PROD_PROV:'8118ff5294bc05a6ba7234d3c50ed71c3f3f764b8ff91200673fcad51b6eefdb'}
...
def analyze(image=IMAGE):
 ...
 validate_apollo_main_artifacts(ROOT,AuditError,'Cordio GATT profile')
 ...
 retained={x.get('name'):x for x in main['regions'] if x.get('name')=='opaque_gatt_profile_literal_pool'}
 expected_retained={'opaque_gatt_profile_literal_pool':(4938426,34,'official_blob')}
