...
def analyze(image=IMAGE):
 ...
 retained={x.get('name'):x for x in main['regions'] if x.get('name') in {'apollo_opaque_after_kvdb_terminal_mode_before_gatt_profile','opaque_gatt_profile_literal_pool'}}
 expected_retained={'apollo_opaque_after_kvdb_terminal_mode_before_gatt_profile':(4916576,21600,'official_blob'),'opaque_gatt_profile_literal_pool':(4938426,34,'official_blob')}
