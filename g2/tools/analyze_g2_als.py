...
def analyze(image=IMAGE):
 ...
 if opt['surface']['linked_functions']!=1 or opt['production']['production_routed']:raise c.AuditError("OPT3007 boundary changed")
