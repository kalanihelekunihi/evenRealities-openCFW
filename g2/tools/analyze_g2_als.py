...
PINS={FM:"c893a36fd7584420ff5b5fd73fa5fbe63e2c90724e5b15b9422807fe7f5dcdda",PM:"8e5fb6091ed60e27a906e392a3620e6c39b73accc22010ac8923f1393877f3a0",CL:"30144a63ce6e066b1670a958b90e3cb84bb71b77098998229080f8fca59cffaa"}
...
SOURCE_PIN=(28117,"fca9e70f4fbe71401f47173afcd89f7e1f894677b68c2faca6b468f34b0b7853")
...
def analyze(image=IMAGE):
 ...
 if any(x.get('profiles')!=['apple-clang'] or not x.get('strict_relocation_contract') or x.get('source',{}).get('license')!='GPL-3.0-only' for x in leaves):raise c.AuditError("ALS production policy changed")
 ...
 if (build['overlay']['size'],build['overlay']['sha256'],build['component']['size'],build['component']['sha256'])!=(332148,'588a29c8d680068b6f27dd2cff831dcfd5aa71a91e4f9f97537d9bcb4a0d145d',3855544,'df6d3b4d5aeffa8e7341937d0d72e3425a6dacfc8fa964cf2b2cda9995079bdc'):raise c.AuditError("ALS canonical component changed")
