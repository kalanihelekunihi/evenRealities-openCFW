...
def analyze(image=IMAGE):
 ...
 if (len(source_bytes),sh(source_bytes))!=(2624,"ac3f5948915be7716d3f2896047a68d46ad87c6e4f0d958233c7df69292df3b0"):raise c.AuditError("codec UART production source changed")
 ...
 if (build["overlay"]["size"],build["overlay"]["sha256"],build["component"]["size"],build["component"]["sha256"])!=(expected["overlay_size"],expected["overlay_sha256"],expected["component_size"],expected["component_sha256"]):raise c.AuditError("codec UART build/overlay accounting diverged")
