...
def analyze(image=IMAGE):
 ...
 overlay=json.loads(OVERLAY.read_text());leaves=overlay["relocated_leaves"][-3:-1];patches=overlay["patch_sites"][-3:-1]
 expected_leaves=(
  ("open_cfw_codec_uart_init",{"alignment":4,"offset":239904,"sha256":"929abebd619582639bd82987d6ef57e35308af73eb223a16f33244e4ed40be76","size":86,"unrelocated_sha256":"3d740b4322ffc06de05e4aae19a51746dc582eb4301a611457ba257681a0c41b"},[(32,"open_cfw_codec_ring_init",0x598160),(46,"open_cfw_codec_uart_set_rx_callback",0x55E8F0),(64,"open_cfw_codec_uart_resume",0x55E5BC)]),
  ("open_cfw_codec_uart_close",{"alignment":4,"offset":239992,"sha256":"f2bde19bd0182d206bcfbb2905ec396c44b5fe207b858d6a5a088ae3f10f20be","size":40,"unrelocated_sha256":"a02bca80ff038e831bf70a6675e623e214a7c91758fbd77f019add55b348d7c0"},[(22,"open_cfw_codec_uart_suspend",0x55E630)]))
 ...
 build=json.loads(BUILD_REPORT.read_text());built=build["relocated_leaves"][-3:-1]
 if (build["overlay"]["size"],build["overlay"]["sha256"],build["component"]["size"],build["component"]["sha256"])!=(240692,"2db11ff707bf253280eb07667c3d76954347cc9e31796c7589faf788fed629ae",3764088,"b3ee7d2fb560f134bd5c4a27eb8203abdc0dd9482816319be0b03320fc2067ed"):raise c.AuditError("codec UART production build pins changed")
