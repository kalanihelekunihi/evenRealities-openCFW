...
def audit(data: bytes) -> dict[str, Any]:
    ...
    return {
        ...
        "effective_configuration": {
            ...
            "LV_USE_BMP": True,
            "LV_USE_SPAN": True,
            "LV_USE_OBJ_ID_BUILTIN": True,
            "LV_DRAW_SW_COMPLEX": False,
        ...
        "abi": {
            ...
            "draw_buffer_handler_size": 0x20,
            "draw_buffer_handler_offsets": [0xC8, 0xE8, 0x108],
            "reconstruction": (
                "Exact with the Ambiq clear/copy handler patch, LV_DRAW_SW_COMPLEX=0, "
                "custom allocation, span, built-in object IDs, and the recovered feature set."
            ),
            "qualification": (
        ...
        "boundary_classification": {
            ...
            "ambiq_backend": (
                "src/draw/ambiq is absent from official LVGL but its exact public Ambiq "
                "subtree is tree 1e774257 at canonical commit 5be8e0ae (with byte-identical "
                "replay 67fd93e2); lv_ambiq_display.c remains separate integration glue"
            ),
            "even_and_platform": (
        ...
        "ambiq_backend_provenance": {
            "repository": "https://github.com/AmbiqMicro/LVGL.git",
            "subtree_path": "src/draw/ambiq",
            "subtree_git_tree_sha1": "1e774257495fa43177e04fc5c8a42a77c2d7d619",
            "canonical_default_branch_commit": "5be8e0ae5077aa3880aba8a322b1487d6bc73c07",
            "equivalent_replay_commit": "67fd93e268f86b2ce90d4f1b14b53e36bf49ddd0",
            "generic_clear_copy_hook_commit": "d4dcd26bd97a0b09778ab9f789b6e7a7354bc967",
            "buffer_wiring_commit": "925470ddbff5f445f6bca3905305ca9d0f2cf5c8",
            "integration_status": "source and public GPU dependency identities closed; production-excluded pending stock-IAR, bare-metal HAL, hardware, and atomic integration closure",
        },
        "nema_dependency_provenance": {
            "repository": "https://github.com/AmbiqMicro/ambiqhal_ambiq.git",
            "ambiqsuite_version": "5.1.0",
            "ambiqsuite_revision": "release_sdk5p1p0-634f7c117b",
            "nemagfx_version": "1.4.12",
            "nemagfx_stock_resolution": "firmware-authenticated lower bound and exact packaged candidate",
            "nemavg_version": "1.1.8",
            "nemavg_stock_resolution": "exact co-packaged candidate; not independently unique from stock bytes",
            "public_reproduction_commit": "b853fded7e545f005727e13bf2ce83018c7e242d",
            "public_subtree_git_tree_sha1": "e690768a6e7b4d6a8d526fc75e8278a2764deff3",
            "apollo5_archive_first_commit": "c6f54a9587fcdc3cd10a9af5db0b602f34d5304f",
            "gpu_patch_first_commit": "e3eec7f3c1148fee3dfa33ca861be176de66c584",
            "command_list_geometry": {"bytes": 102400, "sectors": 100, "sector_bytes": 1024},
            "integration_status": "dependency identity closed; implementation-source and stock-port closure incomplete",
        },
        "integration_policy": [
            ...
            "Use the exact public NemaSDK reproduction commit as the compatibility oracle, but keep the stock-IAR archive, GPU-patch implementation source, bare-metal HAL, hardware validation, and atomic Ambiq integration as explicit gates; keep display glue, FreeType, display manager, input and Even UI as separate ports.",
