...
PINS={FM:'d368e986ca1a14b17e9c86d731d3711c9f70b5c5634483699294696cac6a64e9',PM:'2ffd806820e42a16158ccc6c1638dfeedd8793cd7cb9d4e709a6fd5138e36a31',CL:'fcf56a44acef49c968c0205a9f8fd59fc097dfe81acf3c91b82cafa36f0ccd7d'}
...
def analyze(image=IMAGE):
 ...
 if overlay['expected']!=expected:raise c.AuditError('production Ring policy aggregate overlay pins changed')
 ...
 if (report['overlay']['size'],report['overlay']['sha256'],report['component']['size'],report['component']['sha256'])!=(332148,expected['overlay_sha256'],3855544,expected['component_sha256']) or len(built)!=15 or sum(x['placement']['size'] for x in built)!=570 or sum(x['placement']['padding_before'] for x in built)!=14:raise c.AuditError('production Ring policy build artifact changed')
 manifest=json.loads(MANIFEST.read_text());main=manifest['component_overrides']['apollo_main']
 if (main['provider']['size'],main['provider']['sha256'],manifest['package']['expected_size'],manifest['package']['expected_sha256'])!=(3855544,expected['component_sha256'],4634038,'3953d7a537b11d75c7f589522ae7958bd7c4f59a15d35b98d92d5bec79b90731'):raise c.AuditError('production Ring policy manifest/package pins changed')
