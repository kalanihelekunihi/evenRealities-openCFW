...
def analyze(image=IMAGE):
 ...
 if len(source)!=13444 or sh(source)!='ad8f201b3fe6c4d26b99946d57247abe0cdde44990126c95cbf53da713c2fef2':raise c.AuditError('production EFS transport source changed')
