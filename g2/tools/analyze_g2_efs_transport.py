...
PINS={FM:'5bf8d4181e1f2051e1c3a741ac1bb781257fed67e9797dd6211f59cb70bed2fd',PM:'a8521cc8865ec2e2b82675b6ebaad9ab13cbc26dbb553acb3915da5e0b423ebb',CL:'df2d24deee228a7bbe3563aba6740b2b6dc166cf16eda17cd4d2a92d9cc942e7'}
...
def analyze(image=IMAGE):
 ...
 routed=any('efs_transport' in x.get('path','').lower() for x in json.loads((ROOT/'components/apollo_main/core_overlay/overlay.json').read_text())['sources'])
