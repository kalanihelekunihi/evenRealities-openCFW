...
def audit():
 ...
 require(c["source_owned_bytes"]+c["opaque_base_bytes"]==147350,"byte conservation changed");require(c["source_owned_in_place_bytes"]<=c["source_owned_bytes"],"in-place accounting changed")
