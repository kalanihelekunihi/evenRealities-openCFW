...
struct open_cfw_cordio_wsf_timer_queue {
    struct open_cfw_cordio_wsf_timer *head;
    struct open_cfw_cordio_wsf_timer *tail;
};

extern struct open_cfw_cordio_wsf_timer_queue
...
void open_cfw_cordio_wsf_queue_remove_candidate(
    struct open_cfw_cordio_wsf_timer_queue *queue,
    struct open_cfw_cordio_wsf_timer *timer,
    struct open_cfw_cordio_wsf_timer *previous
);
...
_Static_assert(
    sizeof(struct open_cfw_cordio_wsf_timer_queue) == 0x08U,
    "G2 WSF timer queue size"
);
#endif
