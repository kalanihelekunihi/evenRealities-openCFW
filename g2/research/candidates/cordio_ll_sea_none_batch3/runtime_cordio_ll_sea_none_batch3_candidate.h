...
#ifndef OPEN_CFW_RUNTIME_CORDIO_LL_SEA_NONE_BATCH3_CANDIDATE_H
#define OPEN_CFW_RUNTIME_CORDIO_LL_SEA_NONE_BATCH3_CANDIDATE_H
#include <stddef.h>
#include <stdint.h>
typedef struct {
...
} open_cfw_none_batch3_evidence_t;
typedef struct { uintptr_t words[8]; } open_cfw_none_batch3_invocation_t;
typedef int (*open_cfw_none_batch3_provider_t)(
    void *, const char *, const char *, open_cfw_none_batch3_invocation_t *);
