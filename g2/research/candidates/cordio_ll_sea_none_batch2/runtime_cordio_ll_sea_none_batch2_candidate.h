...
#ifndef OPEN_CFW_RUNTIME_CORDIO_LL_SEA_NONE_BATCH2_CANDIDATE_H
#define OPEN_CFW_RUNTIME_CORDIO_LL_SEA_NONE_BATCH2_CANDIDATE_H
#include <stddef.h>
#include <stdint.h>

typedef struct {
    uint32_t start, end_exclusive;
    size_t bytes;
    const char *module, *function, *license;
} open_cfw_none_batch2_evidence_t;
typedef struct { uintptr_t words[8]; } open_cfw_none_batch2_invocation_t;
typedef int (*open_cfw_none_batch2_provider_t)(
    void *, const char *, const char *, open_cfw_none_batch2_invocation_t *);
