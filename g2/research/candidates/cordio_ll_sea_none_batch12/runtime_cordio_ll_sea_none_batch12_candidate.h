...
#ifndef OPEN_CFW_RUNTIME_CORDIO_LL_SEA_NONE_BATCH12_CANDIDATE_H
#define OPEN_CFW_RUNTIME_CORDIO_LL_SEA_NONE_BATCH12_CANDIDATE_H
...
typedef struct {
  ...
  const char *function;
  const char *license;
} open_cfw_none_batch12_evidence_t;

typedef struct { uintptr_t words[8]; } open_cfw_none_batch12_invocation_t;
typedef int (*open_cfw_none_batch12_provider_t)(
    void *, const char *, const char *, const char *,
    open_cfw_none_batch12_invocation_t *);
