...
#ifndef OPEN_CFW_RUNTIME_CORDIO_LL_SEA_NONE_BATCH10_CANDIDATE_H
#define OPEN_CFW_RUNTIME_CORDIO_LL_SEA_NONE_BATCH10_CANDIDATE_H
...
typedef struct {
  ...
  const char *function;
  const char *license;
  uint8_t in_none_census;
} open_cfw_none_batch10_evidence_t;

typedef struct { uintptr_t words[8]; } open_cfw_none_batch10_invocation_t;
typedef int (*open_cfw_none_batch10_provider_t)(
    void *, const char *, const char *, open_cfw_none_batch10_invocation_t *);
