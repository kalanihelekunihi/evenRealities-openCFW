...
#ifndef OPEN_CFW_RUNTIME_CORDIO_LL_SEA_NONE_BATCH1_CANDIDATE_H
#define OPEN_CFW_RUNTIME_CORDIO_LL_SEA_NONE_BATCH1_CANDIDATE_H
#include <stddef.h>
#include <stdint.h>
...
} open_cfw_none_batch1_evidence_t;
typedef struct { uintptr_t words[8]; } open_cfw_none_batch1_invocation_t;
typedef int (*open_cfw_none_batch1_provider_t)(
    void *, const char *, const char *, open_cfw_none_batch1_invocation_t *);
