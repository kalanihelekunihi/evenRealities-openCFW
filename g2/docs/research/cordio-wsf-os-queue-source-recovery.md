...
- `runtime_cordio_wsf_os_candidate.c`, 9,612 bytes, SHA-256
  `66d8e2a0a06b4ea89c3779b32b1f7bad7522d2fd7d1a3e1134b6c680fc12508e`;
- `runtime_cordio_wsf_os_candidate.h`, 4,366 bytes, SHA-256
  `5e3480211cee74bbfc2ae5bdfe9c281be3a933dc09ee8f775b9bf05830c2baf5`;
- `runtime_cordio_wsf_queue_candidate.c`, 4,781 bytes, SHA-256
  `909db5407f72c0b56b5a50605b142dbb461585f342a397c7acf4a6dbc703d6fa`;
- `runtime_cordio_wsf_queue_candidate.h`, 1,869 bytes, SHA-256
  `19e85f58cfb3329ee3cf6dfe104f8138dc89ffd30dc648ea06f9c467eac2edb1`.
...
hashes, provenance ledgers, Lorelei matrices, production routes, component,
manifest, package, and flash plan. The 18 bounded entries contribute 886
compiled bytes plus 14 alignment bytes under 41 strict relocations.
...
The bounded OS/queue software tranche is production-closed. Live ISR/task
wakeups, dispatcher ordering, timer/message concurrency, and sleep/wakeup
remain blocked by unavailable authorized responsive G2/EM9305 evidence.
