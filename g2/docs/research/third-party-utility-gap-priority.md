...
It is identified but **not yet source-admitted** — no vendored snapshot
exists — so its remaining gap is an explicit admission decision, not identity
or function opacity. See
