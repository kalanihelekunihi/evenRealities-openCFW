...
| `pb_make_string_substream` | 0x48F77E |
...
| `default_extension_decoder` | 0x48FC26 |
| `decode_extension` | 0x48FC88 |
...
Iterator support is retained separately as the contiguous `pb_common.c`
cluster `[0x004D916E,0x004D9522)`: `load_descriptor_values` at `0x004D916E`,
`advance_iterator` at `0x004D930A`, `pb_field_iter_begin` at `0x004D9384`,
`pb_field_iter_begin_extension` at `0x004D93A4`, `pb_field_iter_next` at
`0x004D93D8`, `pb_field_iter_find` at `0x004D93F8`, and
`pb_field_iter_find_extension` at `0x004D946E`. This corrects the earlier
mislabeling of `0x0048F77E`.
