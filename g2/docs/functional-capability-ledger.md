...
| --- | ---: | ---: | ---: | ---: |
| Protocol | 6 | 22 | 4 | 3 |
| Security | 10 | 2 | 2 (including validation blocks) | 1 |
| Platform | 13 | 3 | 6 | 1 |
| Health | 1 | 3 | 1 | 1 |
| System | 4 | 4 | 3 | 0 |
| Storage | 2 | 3 | 2 | 0 |
| Sensors | 5 | 7 | 0 | 1 |
| Hardware services | 6 | 6 | 5 | 1 |
| Deployment | 3 | 0 | 2 | 1 |
...
| Ring service stack (`ring_service`, `thread_ring`, `ring_connect_policy`, `pb_service_ring`, `service_ring_battery`, `cb_ring_battery`) | software-gap / partially implemented / hardware-blocked | `pb_service_ring`: 5 source fn / 1,362 replaced B -> 594 compiled B + 4 alignment B; `service_ring_battery`: 5 fn / 352 replaced B -> 134 compiled B + 4 alignment B; `cb_ring_battery`: 5 fn / 122 replaced B -> 88 compiled B + 2 alignment B; `ring_service`, `thread_ring`, and `ring_connect_policy` retain software gaps | `research/g2-ring-service-dependency-boundary.md`; `g2-thread-ring-dependency-boundary.md`; `g2-ring-connect-policy-dependency-boundary.md`; `g2-pb-service-ring-recovery.md`; `g2-service-ring-battery-recovery.md`; `g2-cb-ring-battery-recovery.md` | protobuf relay, battery state, and callback facade analyzers/host tests green; paired-G2 transport behavior blocked by unavailable physical evidence; three remaining objects require independent C implementation and WSF/ATT validation |
