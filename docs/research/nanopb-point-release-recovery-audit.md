...
0.4.7–0.4.9.** This is a read-only provenance audit. It does not alter production
...
stamp, the defensible claim is **“compatible with unmodified upstream 0.4.7–0.4.9,”**
...
No `nanopb-0.4.4` through `nanopb-0.4.9` string occurs in the image. `NANOPB_VERSION`
...
`LICENSE.txt` SHA-256 in all six tags:
...
`--reference-build`. All three surviving releases produce byte-identical complete
runtime object triplets. This is expected:
...
0.4.7, 0.4.8, and 0.4.9. Selecting one would be guesswork.
